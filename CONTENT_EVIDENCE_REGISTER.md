...
| BF-CASE-C02 | PAGE 壓克力化妝品收納盒 | 2020-03-30 ver.01 Offer Form、產品照片、尺寸圖、影片、3D 設計檔、SKU-like `BF-TP-CH0001-03` | 可核對 W250 × D120 × H240 mm、透明壓克力邊緣拋光、實木、1 SET/CTN、樣品約 15–25 天、量產約 25–35 天的桌上型化妝品展示方向 | 正式產品主資料、MOQ、版本／授權與最終商務條件仍需確認 | 已公開為證據控制的三語產品入口，並新增「產品開發資料紀錄」頁；未核准欄位明確標示，不作完整客戶案例宣稱 |
...
| BF-CASE-C06 | 2016 Apparel Brand Retail | `40_Projects_案例\精選案例照片` 中 3 張成組照片；檔名含 `2016` 與 `clothing brand` | 匿名服飾品牌門市；可辨識中島、壁面、吊掛、桌面配件與鞋類展示方向 | 客戶名稱、Big Fame 實際承擔範圍、正式規格、照片對外授權 | 已公開為三語「證據控制的照片紀錄」；明確不作完整交付案例宣稱 |
...
| BF-CASE-C14 | VELTOR 摩托部品品牌店模組化展示系統 | `40_客戶與市場\B2B\雙生_摩托部品品牌店_VELTOR`、完整店景圖、配置圖 SVG、7 大設備單元實景圖、系統爆炸軸測圖、空間透視與立面圖 | 7 大模組化設備（鞋靴牆、安全帽牆、配件網架、重磅服飾架、中島桌、主題架、諮詢櫃台）、從日常通勤到週末遠行、異材質整合（粉體烤漆鋼構／礦物背板／白蠟木／壓克力）、單一製造夥伴（One Store, One Manufacturing Partner） | 本案為數位雙生／概念店型研發紀錄，非單一特定商業據點之土建裝修成果；量產數量、MOQ、各店交期與特定經銷商合約依新案逐案確認 | 已公開為三語雙生概念案例（TW/EN/JP，含雙路由支援與合約審計驗證） |
